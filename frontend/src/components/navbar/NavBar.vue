  ...
  <div class="drawer-content">
    ...
    <nav class="navbar w-full bg-base-300">
      ...
      <div class="navbar-end">
        <RouterLink v-if="user.isLogin()" :to="{name:'update-character' , params:{character_id:10}}" active-class="btn-active" class="btn btn-ghost text-base mr-6">
          <CreateIcon/>
          创作
        </RouterLink>
        <RouterLink v-if="user.hasPulledUserInfo&&!user.isLogin()" :to="{name:'user-account-login-index'}" active-class="btn-active"  class="btn btn-ghost text-xl">
          登录
        </RouterLink>
  ...
  <div class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-50">
      ...
      <ul class="menu w-full grow">
        ...
        <!-- List item -->
        <li>
          <RouterLink :to="{name:'friend-index'}" active-class="menu-active" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="好友">
            <!-- Friend icon -->
            <FriendIcon/>
        ...
        <li>
          <RouterLink :to="{name:'create-index'}" active-class="menu-active" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="创作">
            <!-- Friend icon -->
            <CreateIcon/>
